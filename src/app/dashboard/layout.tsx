						...
						<li>
							...
							>
								<li>
									<Link
										href="/dashboard/add"
										className="flex border-border hover:bg-gray-50 hover:text-primary group gap-3 rounded-md p-2 text-sm font-semibold"
									>
										<span className="text-muted-foreground border-border group-hover:border-primary group-hover:text-primary flex size-6 shrink-0 items-center justify-center rounded-lg border text-[0.625rem] font-medium bg-white">
